# PCB Preflight API - SMT Stencil Editing
Generate homebase paste pads for specific SMT Components. Easily use intelligent selection filters to access and modify any PCB design obejct.
